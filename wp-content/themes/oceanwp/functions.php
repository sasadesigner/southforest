...
final class OCEANWP_Theme_Class {
	...
	public static function register_sidebars() {
		...
		register_sidebar(
			array(
				'name'          => esc_html__( 'adopt menu', 'oceanwp' ),
				'id'            => 'adopt-menu',
				'description'   => esc_html__( 'Widgets in this area are used in the adopt menu region.', 'oceanwp' ),
				'before_widget' => '<div id="%1$s" class="adopt-menu %2$s clr">',
				'after_widget'  => '</div>',
				'before_title'  => '<' . $foo_heading . ' class="widget-title">',
				'after_title'   => '</' . $foo_heading . '>',
			)
